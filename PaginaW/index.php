...
<head>
    ...
    <title>Selección de Semestre</title>
</head>
<style>
    /* Estilos adicionales para centrar el título */
    h1 {
            text-align: center; /* Centra el título horizontalmente */
            font-size: 100%; /* Tamaño de fuente personalizado */
...
<body style="background-image: url('./img/que-carrera-estudiar.jpg');">
    <nav>
        <ul>
    ...
    <h1 style="color: #fff;">selecciona un Semestre</h1>
    <P style="color:#fff;
    font-family:Calibri,;
    font-size: 100%;
    margin: auto 50px;">Actualmente la Facultad de Ingeniería se encuentra desarrollando un proyecto, cuyo objetivo es realizar un 
prototipo de aplicación móvil, la cual contribuya a la disminución de la contaminación textil, la aplicación permitirá la venta, 
la compra y diseño de las prendas no utilizadas, se centra en la problemática de la moda rápida (fast fashion), 
este es un fenómeno por el cual se comercializan prendas que siguen tendencias actuales, en el que esta es producida a grandes escalas.
De estas prendas producidas gran porcentaje no son utilizadas y no cumplen su ciclo de vida, así mismo prendas que la población 
tiene reservada en su armario y van a ser desechadas, es decir problemas de contaminación ambiental,problema que ocasiona no solo
masiva sino también la de menor escala y la producción de cada uno de los ciclos de vida. En este documento veremos la investigación 
que se ha desarrollado a lo largo del semestre, buscando y aportando soluciones para el desarrollo de la misma aplicación,se analizaron
documentos, proyectos anteriormente realizados y diferentes análisis, quienes contribuyen a la implementación e idea de la app</P>
    <h1 style="color: #fff;">Bienvenidos a Moda Sosteible</h1>
    <P style="color: #fff;
    font-family:Calibri,;
    font-size: 100%;
    margin: auto 50px;">
Un proyecto de desarrollo de software para ropa de segunda mano se centra en la creación de una plataforma digital que facilite la 
compra, venta y gestión de prendas usadas. Este software proporciona a los usuarios una interfaz amigable para listar, buscar y comprar
 ropa de segunda mano, así como herramientas para gestionar sus propias tiendas virtuales. También puede incluir características como 
 evaluaciones de calidad, pagos seguros, integración con redes sociales y sistemas de recomendación para mejorar la experiencia del usuario.
  El proyecto busca fomentar la sostenibilidad y el reciclaje de prendas de vestir mientras ofrece una solución tecnológica eficiente para
   este mercado en crecimiento.</P>
   <img src="./img/moda-ecológica-1-726x516.jpg" alt="chaqueta Hombre">
   <footer class="footer">
    <a class="enlace-footer" href="https://www.facebook.com/" target="_blank"><!--video#2-->
    ...
    <a class="enlace-footer" href="https://www.instagram.com/" target="_blank"><!--video#2-->
    ...
    <a class="enlace-footer" href="https://www.pinterest.es/" target="_blank"><!--video#2-->
    ...
    <p>Copyright© 2022-Todos los derechos reservados Moda Sostenible</p>
</footer>
